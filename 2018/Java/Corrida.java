...
public class Corrida {
    public static void main(String[] args) {
        ...
        int numberRunners = Integer.parseInt(firstLine.split(" ")[0]); // Obtém o 1 número da 1a
                                                                       // linha
...
class Runner { // Classe responsável por guardar a informação do aluno que está correndo
    ...
    public static Runner fastestOf(Runner[] runners) { // Metódo que retorna o (objeto) corredor
                                                       // mais rápido em uma Array de Corredores
